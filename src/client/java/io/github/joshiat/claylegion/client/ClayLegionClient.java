...
public class ClayLegionClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		EntityRendererRegistry.register(EntityRegistry.HORSE_MOUNT, DebugPlaceholderEntityRenderer::new);
		EntityRendererRegistry.register(EntityRegistry.PEGASUS_MOUNT, DebugPlaceholderEntityRenderer::new);
		EntityRendererRegistry.register(EntityRegistry.TURTLE_MOUNT, DebugPlaceholderEntityRenderer::new);
		EntityRendererRegistry.register(EntityRegistry.BUNNY_MOUNT, DebugPlaceholderEntityRenderer::new);
		EntityRendererRegistry.register(EntityRegistry.GECKO_MOUNT, DebugPlaceholderEntityRenderer::new);
