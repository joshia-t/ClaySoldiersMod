...
# BODY      (w=4,h=5,d=2) texOffs(0, 8)
paint_box(entity_img, u=0,  v=8,  w=4, h=5, d=2, shade=0.90)
...
# RIGHT_LEG (w=2,h=3,d=2) texOffs(16,16)
paint_box(entity_img, u=16, v=16, w=2, h=3, d=2, shade=0.72)
# LEFT_LEG  (w=2,h=3,d=2) texOffs(24,16)
paint_box(entity_img, u=24, v=16, w=2, h=3, d=2, shade=0.72)
